...
<div class="border oculto">
    <label id="valJson"></label>
</div>
        ...
        <div class="modal-content">
            <form class="form-horizontal" id="formProduto">
                ...
                <div class="modal-footer">
                    ...
                    <button type="cancel" class="btn btn-secondary" data-disniss="">Cancelar</button>
                </div>
            </form>
        </div>
    </div>
...
$("#formProduto").submit(function(event) {
    ...
    //    Valor igual a nulo cria um novo produto
    if ($("#id").val() != '') {
